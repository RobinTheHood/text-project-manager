...
class BillItemsNewCreator
{
    ...
    // private function getTotalExternalReportPrice(Report $report): float
    // {
    //     // Qunantity
    ...
    //          * @var Qunantity
    //          */
    //         $qunantity = $report->amount->value;

    //         return $qunantity->value * $report->externalPrice->value;
    //     }
    ...
    //          * @var Duration
    //          */
    //         $duration = $report->amount->value;
    //         $externalPrice = $report->externalPrice ? $report->externalPrice->value : 80.00;
    //         return $duration->minutes / 60 * $externalPrice;
    //     }

    //     return 0.0;
    // }

    // private function condenseGroupedDurationReports(array $groupedReporsByDuration)
    // {
    //     $condensatedReports = [];
    //     foreach ($groupedReporsByDuration as $externalPrice => $reports) {
    //         $condensatedReports[$externalPrice] = $this->condenseDurationReports($reports);
    //     }

    //     // $string = '';
    //     // foreach ($condensatedReports as $condensatedReport) {
    //     //     $totalExternalPrice = $condensatedReport['hoursRounded'] * $condensatedReport['externalPrice'];
    //     //     $string .= "{$condensatedReport['hoursRounded']} Std. á {$condensatedReport['externalPrice']}€ = {$totalExternalPrice}€\n";
    //     // }
     ...
     * @param Report[] $reports
     */
    // private function groupReports(array $reports): array
    // {
    //     $groupedRepors = [
    //         'quantity' => [],
    //         'duration' => []
    ...
    //     foreach ($reports as $report) {
    //         if ($report->amount->value instanceof Quantity) {
    //             $groupedRepors['quantitiy'][] = $report;
    //         } elseif ($report->amount->value instanceof Duration) {
    //             $externalPrice = $report->externalPrice ? $report->externalPrice->value : 80.00;
    //             $groupedRepors['duration'][$externalPrice][] = $report;
    //         }
    //     }
    //     return $groupedRepors;
    // }
